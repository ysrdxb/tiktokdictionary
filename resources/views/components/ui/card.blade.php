...
@php
    ...
    $variants = [
        'glass' => 'bg-brand-dark/40 backdrop-blur-xl border border-white/10 hover:border-brand-primary/50 hover:bg-brand-dark/60 shadow-card hover:shadow-card-hover',
        'solid' => 'bg-brand-panel border border-brand-border hover:border-brand-primary shadow-card hover:shadow-card-hover',
