...
<head>
        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    boxShadow: {
                        'card': '0 10px 25px -5px rgba(0, 51, 110, 0.1), 0 8px 10px -6px rgba(0, 51, 110, 0.1)',
                        'card-hover': '0 25px 50px -12px rgba(0, 51, 110, 0.25)',
                        'strong': '0 0 20px rgba(0, 43, 91, 0.25)',
                    }
                }
            }
        }
    ...
    <style>
        html, body, h1, h2, h3, h4, h5, h6, p, span, div, a, button, input, textarea {
        ...
        .premium-card {
            ...
            box-shadow: 0 10px 25px -5px rgba(0, 51, 110, 0.1), 0 8px 10px -6px rgba(0, 51, 110, 0.1);
            position: relative;
            overflow: hidden;
        }
        .premium-card:hover {
            transform: translateY(-5px);
            box-shadow: 0 25px 50px -12px rgba(0, 51, 110, 0.25);
        ...
        .hover\:bg-blue-600:hover, .hover\:bg-black:hover {
...
<body x-data="{}" class="font-sans antialiased bg-white dark:bg-[#00336E] text-slate-900 dark:text-white overflow-x-hidden min-h-screen flex flex-col transition-colors duration-300">
        ...
        <header class="relative z-50 py-6 border-b border-[#00336E]/5 bg-white/80 backdrop-blur-xl">
            <div class="max-w-[1400px] mx-auto px-10 flex items-center">
                ...
                <div class="hidden lg:flex items-center gap-10 ml-auto">
                            ...
                            <div class="flex flex-col items-end">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @if(auth()->user()->is_admin)
                                        <a href="{{ route('admin.dashboard') }}" class="text-[9px] font-bold bg-[#00336E] text-white px-1.5 py-0.5 rounded-sm hover:bg-brand-accent hover:text-[#00336E] transition-colors uppercase tracking-tighter">Admin</a>
                                    @endif
                                </div>
                            </div>
                    ...
                    @else
                        <a href="{{ route('login') }}" class="px-10 py-3 bg-[#00336E] text-white text-sm font-bold rounded-full hover:bg-brand-accent hover:text-[#00336E] transition-all hover:shadow-[0_10px_30px_rgba(0,51,110,0.15)] active:scale-95 transform">
                            Login
                        </a>
                    @endauth
                </div>
            ...
            <div class="max-w-[1240px] mx-auto px-6">
                <div class="text-center mb-10">
                    <div class="flex items-center justify-center gap-2 mb-3">
                        ...
                        <span class="text-2xl font-bold text-[#00336E]">TikTokDictionary</span>
                    </div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                    <div class="text-[#00336E]/60 text-xs md:text-sm font-black uppercase tracking-widest">
                        © Copyright 2025 {{ $siteName }}. All Rights Reserved
                    </div>

                    <div class="flex items-center gap-6">
                        <a href="https://tiktok.com" target="_blank" class="w-12 h-12 rounded-2xl bg-white border border-[#00336E]/10 flex items-center justify-center text-[#00336E] hover:bg-brand-accent hover:border-brand-accent hover:text-[#00336E] transition-all shadow-sm hover:shadow-md" aria-label="TikTok">
                        ...
                        <a href="https://instagram.com" target="_blank" class="w-12 h-12 rounded-2xl bg-white border border-[#00336E]/10 flex items-center justify-center text-[#00336E] hover:bg-brand-accent hover:border-brand-accent hover:text-[#00336E] transition-all shadow-sm hover:shadow-md" aria-label="Instagram">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                        </a>
                        <a href="https://x.com" target="_blank" class="w-12 h-12 rounded-2xl bg-white border border-[#00336E]/10 flex items-center justify-center text-[#00336E] hover:bg-brand-accent hover:border-brand-accent hover:text-[#00336E] transition-all shadow-sm hover:shadow-md" aria-label="X (Twitter)">
