<div x-data="{ open: false, searchTriggered: false }" {{ $attributes }}>
    ...
    <!-- Teleport Menu to Body to excessive nesting issues -->
    <template x-teleport="body">
        <div x-show="open" style="display: none;">
            ...
            <div 
                ...
                class="fixed inset-y-0 right-0 w-4/5 max-w-sm bg-white dark:bg-[#00336E] shadow-2xl z-[100] flex flex-col border-l border-slate-200 dark:border-white/10"
                @click.stop
            >
                <!-- Header -->
