<div class="flex items-center gap-10 text-white/80">
    <!-- Agree Button -->
    <button
        wire:click="vote('agree')"
        class="group flex items-center gap-3 transition-opacity hover:opacity-100 {{ $userVote === 'agree' ? 'text-green-400' : 'hover:text-white' }}"
    ...
    <button
        ...
        class="group flex items-center gap-3 transition-opacity hover:opacity-100 {{ $userVote === 'disagree' ? 'text-red-400' : 'hover:text-white' }}"
