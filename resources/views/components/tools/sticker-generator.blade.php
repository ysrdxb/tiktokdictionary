...
<div x-data="{
    ...
    <!-- Trigger Button -->
    <button @click="generateSticker" :disabled="generating" class="inline-flex items-center gap-2 px-4 py-2 bg-[#002B5B]/5 hover:bg-[#002B5B]/10 text-[#002B5B] text-sm font-bold rounded-lg transition-colors disabled:opacity-50">
