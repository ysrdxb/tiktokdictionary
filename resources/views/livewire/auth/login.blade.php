    ...
    <div class="w-full sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
            ...
            <p class="mt-2 text-sm text-[#002B5B]/60 dark:text-white/60 font-medium">
                Or
                <a href="{{ route('register') }}" class="font-bold text-brand-primary dark:text-brand-accent hover:underline dark:hover:text-white transition-colors" wire:navigate>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input wire:model="remember" id="remember" type="checkbox"
                                class="h-4 w-4 text-brand-primary dark:text-brand-accent focus:ring-brand-primary dark:focus:ring-brand-accent border-slate-300 dark:border-white/20 bg-slate-50 dark:bg-white/10 rounded cursor-pointer">
                            <label for="remember" class="ml-2 block text-sm text-[#002B5B]/70 dark:text-white/70 font-medium cursor-pointer select-none">
                                Remember me
                            </label>
                        </div>
                    </div>
